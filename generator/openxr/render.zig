...
// fn ComptimeStringMap(comptime t: type, comptime values: []std.meta.Tuple(&.{ []const u8, t })) std.StaticStringMap(t) {
//     return std.StaticStringMap([]const u8).initComptime(values);
// }
